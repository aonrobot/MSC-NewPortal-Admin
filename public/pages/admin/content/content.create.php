<div ng-controller="content.create">
    <!-- form start -->
    <form role="form">
        <!-- Step 1 -->
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <img src="pages/admin/content/images/template1.png" class="img-responsive">
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                                        ...
                                        <div class="box-body">
                                            <div class="input-group margin">
                                                <div class="input-group-btn">
                                                    <button type="button" class="btn btn-primary">Choose File (.jpeg or .png)</button>
                                                </div>
                                                <!-- /btn-group -->
