...
class FrontApplicationController extends Controller {
	public function index() {
		...
		$app_group = DB::select('SELECT * FROM application as a LEFT OUTER JOIN app_group as ag ON a.app_id = ag.app_id LEFT OUTER JOIN application_group as g ON ag.group_id = g.group_id ORDER BY a.app_name ASC');
