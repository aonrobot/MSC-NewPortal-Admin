            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <div style="border:1px solid">
                        <h1><i class="fa fa-heart" style="color:#E26A6A"></i> เกิดปัญหาขัดข้องกับระบบ (500)<br><small>{{$exception->getMessage()}}</small></h1>
                    </div>
                    <hr>
                ...
                <div class="col-md-12 text-center">
                    <br><br>
                    <a href="{{asset('/')}}"><button class="btn btn-default">< กลับไปยังหน้าหลัก</button></a>
                </div>
            </div>
        </div>
        <!-- /.row content -->
